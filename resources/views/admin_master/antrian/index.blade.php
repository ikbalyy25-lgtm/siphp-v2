...
<main class="main">
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:28px;">
        ...
        @if($totalPending > 0)
        <form action="{{ route('admin_master.antrian.approveAll') }}" method="POST"
    ...
    <div class="card">
        ...
        <div class="row">
            ...
            <div style="display:flex;gap:6px;">
                <form action="{{ route('admin_master.antrian.approve', $item->id) }}" method="POST">
                    @csrf
                    <button type="submit" class="btn-approve" title="Setujui"><i class="fas fa-check"></i></button>
                </form>
                <form action="{{ route('admin_master.antrian.tolak', $item->id) }}" method="POST"
