...
<div style="max-width:960px;margin:0 auto;padding:40px 24px;">
    ...
    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:36px;flex-wrap:wrap;gap:12px;">
        <div>
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:5px;">
                <a href="{{ route('admin_master.dashboard') }}" style="background:#d0f0c0;border:none;color:#1e3a2f;width:32px;height:32px;border-radius:8px;cursor:pointer;font-size:13px;display:inline-flex;align-items:center;justify-content:center;text-decoration:none;">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:20px;">
        ...
        <a href="{{ route('admin_master.statistik.grafik', [$pasar->id, $kat['id']]) }}" class="kat-card">
