    ...
    <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:28px;flex-wrap:wrap;gap:12px;">
        <div>
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:8px;">
                <a href="{{ route('admin_master.pedagang.index') }}" style="background:var(--g);color:var(--gdd);width:32px;height:32px;border-radius:8px;display:inline-flex;align-items:center;justify-content:center;text-decoration:none;font-size:13px;">
    ...
    <div style="border-radius:16px;overflow:hidden;box-shadow:0 2px 14px rgba(45,106,79,0.08);border:1.5px solid var(--border);">
        ...
        <div class="row-item">
            ...
            <div style="text-align:center;">
                ...
                @else
                    <form action="{{ route('admin_master.pedagang.publish', $h->id) }}" method="POST" style="display:inline;">
                        @csrf
