...
<div style="max-width:1120px;margin:0 auto;">
    ...
    <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:24px;flex-wrap:wrap;gap:12px;">
        <div>
            <div style="display:flex;align-items:center;gap:10px;margin-bottom:5px;">
                <a href="{{ route('admin_master.dashboard') }}" style="background:var(--g);color:var(--gdd);width:32px;height:32px;border-radius:8px;display:inline-flex;align-items:center;justify-content:center;text-decoration:none;font-size:13px;flex-shrink:0;">
    ...
    <div style="border-radius:16px;overflow:hidden;box-shadow:0 2px 14px rgba(45,106,79,0.08);border:1.5px solid var(--border);">
        ...
        <div class="harga-row data-row" data-nama="{{ strtolower($h->nama_barang) }}" data-status="{{ $h->status }}" style="grid-template-columns:2.5fr 1.2fr 1.5fr 1.2fr 0.7fr;">
            ...
            <div style="text-align:center;">
                <form action="{{ route('admin_master.harga.destroy', $h->id) }}" method="POST" style="display:inline;"
