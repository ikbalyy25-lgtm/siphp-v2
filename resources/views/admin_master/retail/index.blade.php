...
<div style="max-width:1120px;margin:0 auto;">
    ...
    <div style="display:flex;align-items:flex-start;justify-content:space-between;margin-bottom:24px;flex-wrap:wrap;gap:12px;">
        ...
        <a href="{{ route('admin_master.retail.create') }}"
    ...
    <div style="padding:64px;text-align:center;background:white;border-radius:16px;border:1.5px dashed var(--border);">
        ...
        <a href="{{ route('admin_master.retail.create') }}" style="color:var(--gd);font-weight:600;font-size:13px;margin-top:8px;display:inline-block;">
